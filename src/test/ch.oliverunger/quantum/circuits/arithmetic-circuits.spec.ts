...
describe('Increment', () => {
    ...
    test('1 qubit: ket(0) -> ket(1)', () => {
        ...
        circuit.execute();
        expStatesToBeCloseTo(reg.states, [_0, _1]);
    });
    ...
    test('1 qubit: ket(1) -> ket(0)', () => {
        ...
        const circuit = createIncrementCircuit(reg);
        circuit.execute();
        expStatesToBeCloseTo(reg.states, [_1, _0]);
    });
    ...
    test('2 qubits: ket(00) -> ket(01)', () => {
        ...
        const circuit = createIncrementCircuit(reg);
        circuit.execute();
        expStatesToBeCloseTo(reg.states, [_0, _1, _0, _0]);
    });
    ...
    test('2 qubits: ket(01) -> ket(10)', () => {
        ...
        const circuit = createIncrementCircuit(reg);
        circuit.execute();
        expStatesToBeCloseTo(reg.states, [_0, _0, _1, _0]);
    });
